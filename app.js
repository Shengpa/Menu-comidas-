    ...
    if (state.showHistory) {
      html += `<div class="card no-print">
        <div class="card-title-row">
          <div class="card-title">Ya hiciste</div>
        ...
        if (isExpanded) {
          ...
          if (w.comodin) {
            html += `<div class="hist-detail">
              ...
              <ul>${(w.comodin.ingredients || []).map((i) => `<li>${escapeHtml(formatIngredient(i))}</li>`).join("")}</ul>
