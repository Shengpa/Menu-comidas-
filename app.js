    ...
    html += `
      <div class="modal-backdrop no-print" id="modal-backdrop">
        <div class="modal">
          ...
          <p class="hint"><strong>Opción automática (tiene costo de API, centavos por semana):</strong> API key de Anthropic. Se guarda solo en este navegador (no se sube a ninguna base de datos).</p>
